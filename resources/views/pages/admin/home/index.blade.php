    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="stat-card p-4">
            ...
            <div class="flex items-end space-x-2">
                <span class="text-3xl font-bold">{{ $totalBooks }}</span>
            </div>
        </div>

        <div class="stat-card p-4">
            <p class="text-sm opacity-80">Total Kategori Buku</p>
            <div class="flex items-end space-x-2">
                <span class="text-3xl font-bold">{{ $totalCategories }}</span>
            </div>
        </div>

        <div class="stat-card p-4">
            <p class="text-sm opacity-80">Total Layanan</p>
            <div class="flex items-end space-x-2">
                <span class="text-3xl font-bold">{{ $totalServices }}</span>
            </div>
        </div>
    </div>
</div>
